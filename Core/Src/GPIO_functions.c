...
void Mode_setting(struct UART_DATA* data) {
    ...
    uint8_t b0 = (HAL_GPIO_ReadPin(mode_button_1_GPIO_Port, mode_button_1_Pin) == GPIO_PIN_RESET);
    uint8_t b1 = (HAL_GPIO_ReadPin(mode_button_2_GPIO_Port, mode_button_2_Pin) == GPIO_PIN_RESET);
    uint8_t b2 = (HAL_GPIO_ReadPin(mode_button_3_GPIO_Port, mode_button_3_Pin) == GPIO_PIN_RESET);
